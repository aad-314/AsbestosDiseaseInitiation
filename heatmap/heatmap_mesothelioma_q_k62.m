% Heatmap for CM and SC for various inputs of q and k62
% q=j, and k62=c where j and c are varied in code below
...
for j = 0.4:0.1:1.4
    ...
    for c = 0.0005:.0001:0.0015
        ...
        q= j; % incomplete phagocytosis rate and also rate of sequestering fibers
        ...
        k62=c; % production rate of IL1 by M2 (Voropaeva)recycled as rate of MP
...
%----------------------------------------------
figure(1)
[X,Y] = meshgrid(0.4:0.1:1.4, 0.0005:.0001:0.0015);%j range, c range
