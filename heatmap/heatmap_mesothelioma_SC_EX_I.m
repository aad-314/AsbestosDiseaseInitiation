...
%%%%%%%%%%%%%%%%%%%%%% PARAMETERS and INPUTS %%%%%%%%%%%%%%%%%%%%%%
        ...
        % Define the initial conditions and create a vector x0 of the initial conditions:
...
% Fig 5D
figure(1)
[X,Y] = meshgrid(500:50:1000,1000:100:2000);%j range, c range
